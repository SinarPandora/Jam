...
package object dream {
   ...
   */
  object API_V2 {
    val modelList: String = "https://swp.cyapi.cn/api/v1/settings/dream_models?bucket=bucket_default_b"

    val sendCaptcha: String = "https://fiction.cyapi.cn/v2/user/phone_message"

    val phoneLogin: String = "https://fiction.cyapi.cn/v2/user/phone_login"

    def novelSave(uid: String): String = s"https://fiction.cyapi.cn/v2/novel/$uid/novel_save"

    def novelAI(uid: String): String = s"https://fiction.cyapi.cn/v2/novel/$uid/novel_ai"

    def addNode(uid: String): String = s"https://fiction.cyapi.cn/v2/novel/$uid/add_node"
